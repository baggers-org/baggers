/* 52e432d57c8ea9b5efccdaf210b9a2aefa84aba6
...
export declare type PortfolioSummaryFragment = ({
    __typename?: 'Portfolio';
} & Pick<Portfolio, 'cash' | 'private' | 'owner' | 'name' | 'description'>);
...
export declare type FullPositionFragment = ({
    __typename?: 'Position';
} & Pick<Position, 'profitLossPercent' | 'profitLossUsd' | 'dailyProfitLossUsd' | 'averagePrice' | 'costBasis' | 'numberOfShares' | 'exposure' | 'marketValue'> & {
    symbol?: Maybe<({
        __typename?: 'Symbol';
    } & Pick<Symbol, '_id'> & {
        quote?: Maybe<({
