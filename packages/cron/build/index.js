...
// src/util/cronFetch.ts
var cronFetch = async (endpoint, options = {}) => {
  const {
    AUTH0_DOMAIN,
    AUTH0_CLIENT_ID,
    AUTH0_CLIENT_SECRET,
  ...
  if (!AUTH0_CLIENT_ID)
    throw new Error(`AUTH0_CLIENT_ID not set`);
  if (!AUTH0_CLIENT_SECRET)
    throw new Error(`AUTH0_CLIENT_SECRET not set`);
  if (!API_URI)
    throw new Error(`API_URI not set`);
...
// src/scheduled/update-symbols/index.ts
