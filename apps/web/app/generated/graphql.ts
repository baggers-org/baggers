...
export type ChartPriceRangeQuery = { __typename?: 'Query', chartPriceRange: Array<{ __typename?: 'Chart', id: string, key: string, subkey: string, date: string, updated: number, change: number, changePercent: number, open: number, close: number, high: number, volume: number, label: string }> };
